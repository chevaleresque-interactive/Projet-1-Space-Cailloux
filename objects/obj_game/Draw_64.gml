// Contexte propre (décalage après rm_gameover...)
draw_set_alpha(1);
...
// Style propre au danger (alignement à droite)
draw_set_halign(fa_right);
draw_set_valign(fa_top);

// Effet de “pulse” bref à chaque changement de palier
...
// Texte principal coloré selon le niveau
